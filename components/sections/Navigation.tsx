      ...
      <div style={{
        ...
        <Link
          ...
          style={{
            ...
            textDecoration: "none",
            color: "#0d0d0f",
            background: "linear-gradient(135deg, #e8b84b 0%, #d4a84b 25%, #c9a84c 50%, #d4a84b 75%, #e8b84b 100%)",
          ...
          onMouseEnter={e => {
            ...
            (e.currentTarget as HTMLAnchorElement).style.boxShadow = "0 8px 24px rgba(201,168,76,0.45)";
          }}
          onMouseLeave={e => {
            (e.currentTarget as HTMLAnchorElement).style.transform = "translateY(0)";
            (e.currentTarget as HTMLAnchorElement).style.boxShadow = "0 4px 16px rgba(201,168,76,0.3)";
          }}
        >
          Start a Project
